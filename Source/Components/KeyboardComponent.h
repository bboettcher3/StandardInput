...
class KeyboardComponent : public juce::Component, public juce::KeyListener {
 ...
 private:
  ...
  std::array<Key, NUM_DEFAULT_KEYS> mKeys = {
      ...
      Key('I', 73),                                                    // I
      Key('O', 79, Utils::PitchClass::Cs + Utils::PitchClass::COUNT),  // O
      Key('P', 80),                                                    // P
      ...
      Key('K', 75, Utils::PitchClass::C + Utils::PitchClass::COUNT),   // K
      Key('L', 76, Utils::PitchClass::D + Utils::PitchClass::COUNT)    // L
  };
